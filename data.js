...
const SEED_ITEMS = [
  ...
  },
  {
    ...
    day: "2026-06-15",
    start: "18:00",
    title: "Basel — accommodation (TBD)",
    subtitle: "Basel · 1 night · not booked yet",
    place: {
      name: "Basel accommodation",
      address: "Basel, Switzerland",
      coords: [47.5596, 7.5886],
    },
    checkIn: "2026-06-15 18:00",
    checkOut: "2026-06-16 12:00",
    endDay: "2026-06-16",
    nights: 1,
    info: [{ label: "Status", value: "Not booked yet" }],
    badges: ["To book"],
    notes:
      "Placeholder — no booking yet for the night of 15→16 Jun in Basel. Tap Edit to add the name, address, confirmation and notes once it's booked.",
  },
